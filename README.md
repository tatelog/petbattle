...
![全画面バトルUI](public/demo/petbattle-battle-fullscreen.jpg)

バトル中はキャラ枠を表示せず、3つのコマンドをコロシアム内へ重ねて表示できます。中央の `FULL SCREEN` からバトル領域だけを全画面化できます。

![複数試合型のXP結果](public/demo/petbattle-progression-result.jpg)

![テーマ指定型SVG Evolution Quest](public/demo/petbattle-evolution-studio.jpg)
